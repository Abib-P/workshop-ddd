...
class AddActivityToTravelTest {
    ...
    fun `should add activity to travel`() {
        ...
        whenever(travels.getById(any())).thenReturn(
            Travel(
                id = GenericID.EMPTY,
                period = Period(LocalDateTime.of(2019, 1, 1, 0, 0), LocalDateTime.of(2021, 1, 1, 0, 10)),
                client = Client(
                    GenericID.EMPTY,
                    Mail("mail@mail"),
    ...
    @Test
    fun `should not add activity to travel when activity is not in travel period`() {
        whenever(activities.getById(any())).thenReturn(
            Activity(
                id = GenericID.EMPTY,
                name = "Activity name",
                description = "Activity description",
                price = 10.0,
                duration = Period(LocalDateTime.of(2019, 1, 1, 0, 0), LocalDateTime.of(2020, 1, 1, 0, 10)),
                restrictions = listOf(AgeActivityRestriction(18, 100)),
                address = Address("City", "Country"),
                capacity = 1
            )
        ...
        whenever(travels.getById(any())).thenReturn(
            Travel(
                id = GenericID.EMPTY,
                period = Period(LocalDateTime.of(2020, 1, 1, 0, 0), LocalDateTime.of(2021, 1, 1, 0, 10)),
                client = Client(
                    GenericID.EMPTY,
                    Mail("mail@mail"),
                    LocalDate.now().minusYears(18),
